...
import 'package:flutter_extensions/src/flutter/widgets/listenable/listenable_consumer_base.dart';
...
class ChangeableValueConsumer<T extends Listenable, V>
    extends ChangeableValueConsumerBase<T, V>
  ...
  @override
  _ChangeableValueConsumerState<T, V> createState() =>
      _ChangeableValueConsumerState<T, V>();
}
...
class ChangeableValueListener<T extends Listenable, V>
    extends ChangeableValueConsumerBase<T, V> with ChangeableValueListenerBase<T, V> {
  final bool Function(V before, V after) listenWhen;
  final void Function(BuildContext context, V value) listener;
  final Widget child;
  ...
  @override
  _ChangeableValueListenerState<T, V> createState() =>
...
class ChangeableValueBuilder<T extends Listenable, V>
    extends ChangeableValueConsumerBase<T, V> with ChangeableValueBuilderBase<T, V> {
  final bool Function(V before, V after) buildWhen;
  final Widget Function(BuildContext context, V value) builder;
  ...
  @override
  _ChangeableValueBuilderState<T, V> createState() =>
      _ChangeableValueBuilderState<T, V>();
}
